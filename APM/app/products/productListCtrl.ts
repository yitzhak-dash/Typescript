module app.productList {
    ...
    class ProductListCtrl implements IProductListModel {
        ...
        constructor() {
            ...
            var newProduct = new app.domain.Product(3, "garden cat", "AAA-123", new Date(2016, 3, 21),
                100, "White garden cat", "http://openclipart.org/image/300px/svg_to_png/73/garden_cat.png");
